...
- провели эксперименты с различной предобработкой данных (удаление стоп-слов,
  удаление пунктуации, лемматизация), разными способами создания признаков
  (Bag-of-Words, TF-IFD, текстовые статистики) и семействами моделей (линейные

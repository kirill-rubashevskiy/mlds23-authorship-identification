...
- проанализировали статистики из текстов различными способами
- критически оценили нграммы (уни-, би- и триграммы)
- проанализировали части речи
...
Усредненные по авторам статистики можно посмотреть в [ноутбуке](./EDA/EDA_DM.ipynb).
